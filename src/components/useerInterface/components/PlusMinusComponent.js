...
<Fab style={{background:'rgb(18, 218, 168)',color:'#000'}} size="small" onClick={handleAdd}  aria-label="add">
 ...
 {props.screen=='cart'?<></>:
 <Button onClick={handlecontinue}  style={{ height:40, color: '#191919', borderColor: '#353535', background: '#12daa8',  marginLeft: '10px',borderRadius: 10, fontWeight: 'bold', textTransform: 'none' }} variant="outlined">Continue Shopping</Button>}
